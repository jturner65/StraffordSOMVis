...
public class my3DCanvas {
	...
	public my3DCanvas(SOM_StraffordMain _p) {
		p = _p;
...
class edge{ 
	public SOM_StraffordMain p;
	public myPoint a, b;
	public edge (SOM_StraffordMain _p){this(_p,new myPoint(0,0,0),new myPoint(0,0,0));}
	public edge (SOM_StraffordMain _p, myPoint _a, myPoint _b){p = _p;a=new myPoint(_a); b=new myPoint(_b);}
