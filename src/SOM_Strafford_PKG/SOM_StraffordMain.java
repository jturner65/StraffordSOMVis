 ...
 * 
 */
public class SOM_StraffordMain extends PApplet {
...
///////////////	
	...
	if(!callFlags){//called from setflags - only sets button state in UI to avoid infinite loop
		...
		switch(btn){
			case 0 : {setFlags(showSOMMapUI, bVal);break;}
			}
		}
	}//handleShowWin
...
//	}//handleAddDelSelCmp	
	...
	private final int cnslStrDecay = 10;			//how long a message should last before it is popped from the console strings deque (how many frames)
	...
	public final int drawing			= 7; 			//currently drawing  showSOMMapUI
	...
	public final int showSOMMapUI		= 14;			//whether to show SOM  window
	...
	public boolean[] canDrawInWin = new boolean[]{false,false};		
	public boolean[] canShow3DBox = new boolean[]{false,false};		
	public boolean[] canMoveView = new boolean[]{false,false};		
	public static final boolean[] dispWinIs3D = new boolean[]{false,false};
	...
	public int[] winFlagsXOR = new int[]{showSOMMapUI};//showSequence,showSphereUI};
	//specify windows that cannot be shown simultaneously here
	public int[] winDispIdxXOR = new int[]{dispSOMMapIDX};//dispPianoRollIDX,dispSphereUIIDX};
