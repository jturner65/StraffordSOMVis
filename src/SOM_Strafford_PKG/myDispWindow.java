...
class mySideBarMenu extends myDispWindow{
	...
	public mySideBarMenu(SOM_StraffordMain _p, String _n, int _flagIdx, int[] fc, int[] sc, float[] rd, float[] rdClosed, String _winTxt, boolean _canDrawTraj) {
...
class myDrawnSmplTraj {
	...
	public myDrawnSmplTraj(SOM_StraffordMain _p, myDispWindow _win,float _topOffy, int _fillClrCnst, int _strkClrCnst, boolean _flat, boolean _smCntl){
		pa = _p;
...
class myScrollBars{
	...
	public myScrollBars(SOM_StraffordMain _pa,myDispWindow _win){
		pa = _pa;
		win = _win;
		ID = scrBarCnt++;
		setSize();
