...
/**
 * this class will be used to describe a segment of the SOM containing  
 * a collection of nodes that are similar to one another.  This will be used for 
...
public class SOMMapSegment {
	...
	//threshold of u-dist for nodes to be considered similar. (0..1.0) (not including bounds)
	protected float thresh;
	//map nodes making up this segment
	...
	public SOMMapSegment(SOMMapManager _mapData, float _thresh) {
