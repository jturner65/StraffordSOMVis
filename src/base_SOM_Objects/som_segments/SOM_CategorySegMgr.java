...
public class SOM_CategorySegMgr extends SOM_SegmentManager {
	...
	public SOM_CategorySegMgr(SOMMapNode _owner) {
		super(_owner);
	...
	public void clearAllSegData() {
		...
		if(mappedCategoryCounts.size()!=segData.size()) {
			msgObj.dispInfoMessage("SOM_CategorySegMgr", "clearAllSegData", "Error : mappedCategoryCounts.size() : " + mappedCategoryCounts.size() + " is not equal to segData.size() : " + segData.size());
		}
