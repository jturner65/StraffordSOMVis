...
public abstract class SOMMapNode extends SOMExample{
	...
	@Override
	protected void setIsTrainingDataIDX_Priv() {mapMgr.msgObj.dispMessage("SOMMapNode","setIsTrainingDataIDX_Priv","Calling inappropriate setIsTrainingDataIDX_Priv for SOMMapNode - should never have training index set.", MsgCodes.warning2);	}
	@Override
	...
	protected void buildStdFtrsMap() {
		mapMgr.msgObj.dispMessage("SOMMapNode","buildStdFtrsMap","Calling inappropriate buildStdFtrsMap for SOMMapNode : should call buildStdFtrsMap_MapNode from SOMDataLoader using trained map w/arrays of per feature mins and diffs", MsgCodes.warning2);		
	}
