 ...
 *
 */
public class Straff_ProdMappingOutputBuilder_FtrsAndBMUs extends Straff_ProdMappingOutputBuilder_Base {

	protected int prodDistType;
	protected double prodZoneDistThresh;

	public Straff_ProdMappingOutputBuilder_FtrsAndBMUs(Straff_SOMMapManager _mapMgr, String _fileName, ExecutorService _th_exec, int _pDistType, double _pZnDistThresh) {
