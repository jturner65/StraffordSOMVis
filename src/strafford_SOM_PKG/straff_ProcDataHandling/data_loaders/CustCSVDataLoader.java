...
public class CustCSVDataLoader extends SOM_ExCSVDataLoader{

	public CustCSVDataLoader(SOM_MapManager _mapMgr, int _thdIDX, String _fileName, String _yStr, String _nStr,
	...
	@Override
	protected synchronized SOM_Example buildExample(String oid, String str) {return new CustProspectExample(mapMgr, oid, str);}
