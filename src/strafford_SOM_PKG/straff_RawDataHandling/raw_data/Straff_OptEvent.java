...
public class Straff_OptEvent extends Straff_EventRawData{
    ...
    public Straff_OptEvent(MessageObject _msgObj,String _id, String _json, ObjectMapper _mapper, boolean hasJson) {
