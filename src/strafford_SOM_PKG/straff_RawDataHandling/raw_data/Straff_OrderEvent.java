...
public class Straff_OrderEvent extends Straff_EventRawData{
	...
	public Straff_OrderEvent(MessageObject _msgObj,String _id, String _json, ObjectMapper _mapper, boolean hasJson) {super(_msgObj,_id, _json, _mapper,"orders",hasJson); this.isBadRec = rawJpMapOfArrays.size() == 0;}
