...
public class Straff_LinkEvent extends Straff_EventRawData{
    ...
    public Straff_LinkEvent(MessageObject _msgObj,String _id, String _json, ObjectMapper _mapper, boolean hasJson) {super(_msgObj,_id, _json, _mapper,"links",hasJson);this.isBadRec = rawJpMapOfArrays.size() == 0;}
