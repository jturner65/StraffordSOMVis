 ...
 *
 */
public class Straff_JpgJpDataRecord {
	...
	public Straff_JpgJpDataRecord(int _jpg, int _priority, int _optVal) {
		JPG = _jpg;
	...
	public Straff_JpgJpDataRecord(int _jpg, int _priority, int _optVal, String _csvString) {
